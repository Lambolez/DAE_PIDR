...
<xsl:template match="cc">
  ...
  <page_element_list_item>
	...
	<boundary_list>
	  <boundary_list_item>
	    <xsl:variable name="xpoints" select="skeleton/xpoints"/>
		<xsl:variable name="ypoints" select="skeleton/ypoints"/>
		...
		<type>CVC skeleton</type>
		<value><xsl:value-of select="translate(translate($points,'&#10;', ''), '&#09;', '')" /></value>
	  </boundary_list_item>
      <boundary_list_item>
