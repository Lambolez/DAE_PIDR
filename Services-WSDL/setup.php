 ...
 * @var $htmlBaseDir
 */
$htmlBaseDir = '/opt/csw/apache2/share/htdocs';
 ...
 * @var $WSDLURL
 */
$domainname = '.cse.lehigh.edu';
$hostname = (!isset($PHP_MAJOR_VERSION) || $PHP_MAJOR_VERSION < 5 || ($PHP_MAJOR_VERSION == 5 && $PHP_MINOR_VERSION <= 2) ? php_uname('n').$domainname : gethostname());
