...
$outputT = array();
$outputT['dice_page_text'] = array('name'=>'dice_page_texte', 'type'=>'xsd:string');
$outputT['dice_page_hw'] = array('name'=>'dice_page_hw', 'type'=>'xsd:string');
$outputT['dice_page_picture'] = array('name'=>'dice_page_picture', 'type'=>'xsd:string');
...
function callback($input) {
	...
	$execString = "/dae/database/upload/321/dice_scripts/dice_helper.sh $localname $localdir";
	/* \todo Should check return value for system call */
	system($execString);
 ...
 *  
 */ 
$server->wsdl->addComplexType($algoname.'Input', 'complexType',	'struct',
							  'all', '', $inputT);
 ...
 *  
 */ 
$server->wsdl->addComplexType($algoname.'Output', 'complexType', 'struct', 
							  'all', '', $outputT);

// Register the method to expose
$server->register('callback',                	// method PhP callback function
		array('args' => 'tns:'.$algoname.'Input'),  	//input parameters
		array('return' => 'tns:'.$algoname.'Output'), // output parameters
